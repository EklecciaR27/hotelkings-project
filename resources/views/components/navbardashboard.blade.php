...
<div class=" flex items-center justify-center bg-sky-500 sticky top-0 z-10">
    ...
    <nav class="flex flex-row p-8 px-4 justify-between items-center sticky top-20 z-10">
        <ul class="hidden lg:flex items-center font-bold gap-28 justify-center text-white ml-80">
          <li class="hover:text-neutral-900"><a href="{{ url('data/home') }}">HOME</a></li>
          <li class="hover:text-neutral-900"><a href="{{ url('data/chart') }}">CHART</a></li>
          <li class="hover:text-neutral-900"><a href="{{ url('data/reservasi') }}">RESERVASI</a></li>
          <li class="hover:text-neutral-900"><a href="{{ url('data/guest') }}"> GUEST</a></li>
          <li class="hover:text-neutral-900"><a href="{{ route('logout') }}" > <i class="fas fa-sign-out-alt"></i></a></li>
        </ul>
